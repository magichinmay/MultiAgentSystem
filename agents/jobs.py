...
class SchedulerAgent(Agent):
    def __init__(self, jid, password):
        ...
        operation_list=scheduler1.operation_data

        print("Machine Sequence", operation_list)
        print("Machine Sequence", operation_list[0])
        ...
        print("AMR1 Machine sequence and it ptime", self.coordinates1,self.ptime1)
        
        self.coordinates2 = chromsome1.amr_machine_sequences[1]
        self.ptime2=chromsome1.amr_ptime_sequences[1]
        print("AMR2 Machine sequence and its ptime", self.coordinates2,self.ptime2)
        
        if amrs>=3:
            self.coordinates3 = chromsome1.amr_machine_sequences[2]
            self.ptime3=chromsome1.amr_ptime_sequences[2]
            print("AMR3 Machine sequence and its ptime", self.coordinates3,self.ptime3)
        ...
        self.state3 = "waiting for schedule"  # Added initialization for state2
            ...
            while x==True:
                ...
                if msg:
                    ...
                    if performative == "Register":
                        ...
                        point1 = self.agent.coordinates1[self.agent.index2]  # Access agent's coordinates
                        time1 = self.agent.ptime2[self.agent.index2]
                        data1=[point1,time1]
                        ...
                        # Update index or mark completion
                        if self.agent.index2 < len(self.agent.coordinates1)-1:
                            self.agent.index2 += 1
                        else:
                        ...
                        point2 = self.agent.coordinates2[self.agent.index3]  # Access agent's coordinates
                        time2 = self.agent.ptime3[self.agent.index3]
                        data2=[point2,time2]
...
if __name__ == "__main__":
    scheduler_agent = SchedulerAgent("Jobs@jabber.fr", "changeme")
